(async function(global){
  // ── 版本變更記錄 ──────────────────────────────────────
  // v13149: 2026-04-02 17:22:00 | 模擬 Wi-Fi 新增設備端內框架頁 setup-mini-sim.html，未連 AP 也可完整測試內框架流程
  // v13148: 2026-04-02 17:05:00 | 修正 setup.html 重複頁面導致連線出現 ERR_FAILED，並強制模擬版快取升版
